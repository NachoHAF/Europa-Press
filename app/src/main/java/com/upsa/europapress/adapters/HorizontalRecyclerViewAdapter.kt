...
class HorizontalRecyclerViewAdapter(val articles: MutableList<Article>, val titleChannel: Channel) :
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        val itemImage: ImageView = view.findViewById(R.id.imageBanner)
        val itemTitle: TextView = view.findViewById(R.id.titleBanner)
        ...
        fun bind(article: Article) {
            ...
            if (article.image.toString() == "null") {
                loadImage = "https://pbs.twimg.com/media/E1XvJKzVUAMdZWW.jpg"
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(viewGroup.context).inflate(R.layout.image_banner_layout, viewGroup, false)
