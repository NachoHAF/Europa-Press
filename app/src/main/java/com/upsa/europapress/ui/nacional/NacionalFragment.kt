package com.upsa.europapress.ui.nacional
...
import com.upsa.europapress.databinding.FragmentNacionalBinding
import www.sanju.motiontoast.MotionToast

class NacionalFragment : Fragment() {

    private lateinit var viewModel: NacionalViewModel
    ...
    override fun onCreateView(
        ...
        binding.recyclerViewSpain.adapter = adapterArticle
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // 初始化
        viewModel = ViewModelProvider(this)[NacionalViewModel::class.java]
        parser =
            Parser.Builder()
        ...
        // 新闻列表
        val recyclerView = binding.recyclerViewSpain
