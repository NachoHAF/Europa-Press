package com.upsa.europapress.ui.sociedad
...
import com.upsa.europapress.databinding.FragmentSociedadBinding
import www.sanju.motiontoast.MotionToast

class SociedadFragment : Fragment() {

    private lateinit var viewModel: SociedadViewModel
    private lateinit var parser: Parser
    private lateinit var adapterArticle: ArticleAdapter

    private var _binding: FragmentSociedadBinding? = null
    private val binding
        get() = _binding!!
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSociedadBinding.inflate(inflater, container, false)
        // 初始化
        adapterArticle = ArticleAdapter(mutableListOf(), Channel())
        binding.recyclerViewSociedad.adapter = adapterArticle
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // 初始化
        viewModel = ViewModelProvider(this)[SociedadViewModel::class.java]
        parser =
            Parser.Builder()
        ...
        // 新闻列表
        val recyclerView = binding.recyclerViewSociedad
