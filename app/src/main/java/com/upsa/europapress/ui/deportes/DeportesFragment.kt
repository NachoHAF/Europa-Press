package com.upsa.europapress.ui.deportes
...
import com.upsa.europapress.databinding.FragmentDeportesBinding
import www.sanju.motiontoast.MotionToast

class DeportesFragment : Fragment() {

    private lateinit var viewModel: DeportesViewModel
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        binding.recyclerViewDeportes.adapter = adapterArticle
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // 初始化
        viewModel = ViewModelProvider(this)[DeportesViewModel::class.java]
        parser = Parser.Builder().context(requireContext()).cacheExpirationMillis(10L * 60L * 100L).build()

        // 新闻列表
        val recyclerView = binding.recyclerViewDeportes
