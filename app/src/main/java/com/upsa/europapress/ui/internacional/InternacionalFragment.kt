...
import com.upsa.europapress.databinding.FragmentInternacionalBinding
...
class InternacionalFragment : Fragment() {
    ...
    private var _binding: FragmentInternacionalBinding? = null
    private val binding
        get() = _binding!!

    private lateinit var viewModel: InternacionalViewModel
    ...
    override fun onCreateView(
        ...
        _binding = FragmentInternacionalBinding.inflate(inflater, container, false)
        // 初始化
        adapterArticle = ArticleAdapter(mutableListOf(), Channel())
        binding.recyclerViewInternacional.adapter = adapterArticle
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // 初始化
        viewModel = ViewModelProvider(this)[InternacionalViewModel::class.java]
        ...
        // 新闻列表
        val recyclerView = binding.recyclerViewInternacional
