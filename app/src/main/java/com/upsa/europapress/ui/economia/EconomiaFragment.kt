package com.upsa.europapress.ui.economia
...
import com.upsa.europapress.databinding.FragmentEconomiaBinding
import www.sanju.motiontoast.MotionToast

class EconomiaFragment : Fragment() {

    private lateinit var viewModel: EconomiaViewModel
    private lateinit var parser: Parser
    private lateinit var adapterArticle: ArticleAdapter

    private var _binding: FragmentEconomiaBinding? = null
    private val binding
        get() = _binding!!
    ...
    override fun onCreateView(
        ...
        _binding = FragmentEconomiaBinding.inflate(inflater, container, false)

        // 初始化
        adapterArticle = ArticleAdapter(mutableListOf(), Channel())
        binding.recyclerViewEconomia.adapter = adapterArticle
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // 初始化
        viewModel = ViewModelProvider(this)[EconomiaViewModel::class.java]
        parser =
            Parser.Builder()
        ...
        // 新闻列表
        val recyclerView = binding.recyclerViewEconomia
